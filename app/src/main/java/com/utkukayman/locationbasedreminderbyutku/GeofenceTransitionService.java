...
public class GeofenceTransitionService
    ...
    private String getGeofenceTransitionDetails(
        ...
        Log.d(TAG, "GeofenceTransitionService : getGeofenceTransitionDetails");
        ...
        ReminderDetails reminder =Utils.get(getApplicationContext(),triggeringGeofencesIdsList.get(triggeringGeofencesIdsList.size()-1));
    ...
    private void sendNotification(String notificationDetails) {
        ...
        Log.d(TAG, "GeofenceTransitionService : sendNotification");
        ...
        builder.setSmallIcon(R.drawable.ic_flash_on_black_24dp)
